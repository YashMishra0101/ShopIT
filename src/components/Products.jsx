...
const Products = () => {
    return (
        <div className='dark:bg-gray-900 pt-24 pb-10 dark:text-white'id='products'>
            ...
            <div>
                ...
                <div className='flex justify-center'>
                    <button data-aos="fade-up" data-aos-offset="20" className='text-center mt-10 cursor-pointer bg-primary text-white py-1 px-5 rounded-md'>
                        View All Button
                    </button>
                </div>
            </div>
