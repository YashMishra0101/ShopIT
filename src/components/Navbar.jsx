...
return (
    <div className='shadow-md bg-white dark:bg-gray-900 dark:text-white duration-200 z-40 fixed w-full'>
        ...
        {/*Lower Navbar*/}
        <div data-aos="zoom-in" className='flex justify-center'> {/*Animate on scroll for the content below */}
            ...
            <li className="group relative cursor-pointer">
                <a href="#" className="flex hover:text-primary items-center gap-[2px] py-2">
                Trending Products
                <span>
